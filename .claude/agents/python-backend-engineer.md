...
Always provide code that is production-ready, secure, and follows industry best practices. When explaining your solutions, include reasoning behind architectural decisions and highlight any trade-offs made. Follow the project's established documentation standards with structured docstrings including PURPOSE, DESCRIPTION, ARGUMENTS, and RETURNS sections.
